    ...
    >
      ...
      <div class="px-[25px] pt-[18px] pb-[25px] md:px-[36px] md:pt-[22px] md:pb-[33px]">
        ...
        <div class="flex justify-between items-end">
            <h3 class="text-[16px] md:text-[20px] font-medium leading-[25px] md:leading-[30px] mt-[19px]">{{ title }}</h3>
            <svg class="w-9 h-auto mb-2" viewBox="0 0 24 8" fill="none" xmlns="http://www.w3.org/2000/svg">
